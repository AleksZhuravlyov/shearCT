...
/// This class is realisation of orthogonal coordinate system based on CGAL library.
class Basis {
...
public:
    ...
    */
    ...
    /**
     Accessor for x, y ans z coordinates of origin_.
     @return shared pointer of std::vector<double> with x, y ans z coordinates of origin_.
    */
    std::shared_ptr<std::vector<double>> getXYZOrigin();
