...
std::shared_ptr<std::vector<double>> Basis::getXYZOrigin() {
    std::vector<double> xYZOrigin;
    xYZOrigin.push_back(origin_.x());
    xYZOrigin.push_back(origin_.y());
    xYZOrigin.push_back(origin_.z());
    return std::make_shared<std::vector<double>>(xYZOrigin);
}
